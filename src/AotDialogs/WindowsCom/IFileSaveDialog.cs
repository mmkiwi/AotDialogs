    ...
    : IFileDialog
{
    ...
    /// </remarks>
    void SetCollectedProperties(IPropertyDescriptionList pList, [MarshalAs(UnmanagedType.Bool)] bool fAppendDefault);
    ...
    /// </remarks>
    void ApplyProperties(IShellItem psi, IPropertyStore pStore, nint hwnd, IFileOperationProgressSink pSink);
}